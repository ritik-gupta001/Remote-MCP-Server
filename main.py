...
# Prefer project directory for DB so it's easy to find; fall back to temp dir if not writable
import os
try:
...
# Prefer to create the DB next to this main.py so users can find it easily. If the project
# directory isn't writable (e.g., installed location), fall back to the OS temp directory.
